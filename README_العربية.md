...
### **ملخصات المقترحات التلقائية<br>لمجتمع Qubic بـ 13 لغة**
...
1. **إدارة المجموعة**
2. **إضافة الأعضاء**
3. **ابحث عن البوت:** `@QubicTranslationBot`
4. **أضف إلى المجموعة** كمسؤول
5. **قم بالإعداد** في الدردشة المطلوبة باستخدام `/setup`

> [!IMPORTANT]
> يجب استخدام أمر `/setup` <ins>**بالضرورة**</ins> في الدردشة التي يجب أن تنشر فيها الملخصات.
